...
#TODO: Ideas
# - Add legend to plot with coloring code, also add a paramter to AddSpectra and contructor to provide a name for legend (better a side panel)
...
plotSpectra<-function(clicFuntion = NULL)
{
  window <- gwindow ( "Spectra Plot" , visible = F , width = 750, height = 440) #using window just as a test! Finally it should be a Widget!
  pWidget<-SpectraPlotWidget(window, clicFun = clicFuntion)
  pWidget$.Init()
  window$widget$present() ##Tot i forzzar aki un raise-up del top widget en RStudio no deixa!
  return(pWidget)
}

setConstructorS3("SpectraPlotWidget", function(parent_widget=gwindow ( "Default SpectraPlotWidget" , visible = FALSE ), clicFun = NULL)
{
  extend(Object(), "SpectraPlotWidget",
...
#Add spectrum data
setMethodS3("AddSpectra", "SpectraPlotWidget", function(this, mass_data, intensity_data, mass_peaks = 0, intensity_peaks = 0, col = "", ...)
{
...
setMethodS3("SetRefMass", "SpectraPlotWidget", function(this, mass_data, ...)
{
...
setMethodS3("RmSpectra", "SpectraPlotWidget", function(this, index, ...)
{
...
setMethodS3("ClearSpectra", "SpectraPlotWidget", function(this, ...)
{
...
setMethodS3(".Init", "SpectraPlotWidget", function(this, showOpenFileButton = T, ...)
{
...
setMethodS3(".plot", "SpectraPlotWidget", function(this,...)
{
...
#    }
  ...
  #Update cursor
  this$.CheckBox_Changed(this,...)

})

#.OpenTXT
setMethodS3(".OpenTXT", "SpectraPlotWidget", function(this, evt, ...)
{
  fname<-file.choose()
...
setMethodS3(".ZoomResetClicked", "SpectraPlotWidget", function(this, evt, ...)
{
  if(length(this$.spectra_mass) == 0) return()
...
#Auto Zoomin Mz axis
setMethodS3(".ZoomMzClicked", "SpectraPlotWidget", function(this, evt, ...)
{
  if(length(this$.spectra_mass) == 0) return()
  this$.mz_lim = this$.data_mass_range
  this$.plot()
...
setMethodS3(".ZoomInClicked", "SpectraPlotWidget", function(this, evt, ...)
{
  if(length(this$.spectra_mass) == 0) return()
  this$.AutoZoomIntensity()
  this$.plot()
...
#Auto Change cursor
setMethodS3(".CheckBox_Changed", "SpectraPlotWidget", function(this, evt, ...)
{
...
#Intensity auto-zoom
setMethodS3(".AutoZoomIntensity", "SpectraPlotWidget", function(this, ...)
{
...
setMethodS3(".OnResize", "SpectraPlotWidget", function(this, evt, ...)
{
  this$.plot()
  return(TRUE)
})
...
setMethodS3(".OnSelection", "SpectraPlotWidget", function(this, evt, ...)
{
  if(length(this$.spectra_mass) == 0) return(TRUE)
  if(svalue(this$.radio_buttons) == "Zoom")
  {
...
setMethodS3(".OnMouseMotion", "SpectraPlotWidget", function(this, evt, ...)
{
  if(length(this$.spectra_mass) == 0) return(TRUE)
...
setMethodS3(".ScrollEventOnSpectra", "SpectraPlotWidget",function(this, evt, ...)
{
  if(length(this$.spectra_mass) == 0) return(TRUE)
...
#Key Press handler
setMethodS3(".OnKeyPress", "SpectraPlotWidget", function(this, evt, ...)
{
...
#Key Release handler
setMethodS3(".OnKeyRelease", "SpectraPlotWidget", function(this, evt, ...)
{
  if(evt[[4]][["keyval"]] == 65507)
  {
...
setMethodS3(".OnLostFocus", "SpectraPlotWidget", function(this, evt,...)
{
  this$.MouseWheelFunction<-0
